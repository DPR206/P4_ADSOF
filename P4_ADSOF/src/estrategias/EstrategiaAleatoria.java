...
/**
 * Esta clase representa un tipo de estrategia de lectura que genera un valor aleatorio en un rango
 * 
...
public class EstrategiaAleatoria implements Estrategia {
     ...
     * @param probFueraRango Probabilidad de que el valor se encuentre fuera del rango
     */
	...
	public double generarValor() {
		if (rand.nextDouble() < probFueraRango) {
            // Fuera de rango
            if (rand.nextBoolean()) {
